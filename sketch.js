...
function preload() {
  ...
  sunAnimation = loadImage("sun51.png");

  trex_running = loadAnimation("t-rex1.png", "t-rex2.png", "t-rex3.png");
  trex_collided = loadAnimation("t-rex2.png");
...
function setup() {
  ...
  restart = createSprite(width/2, height/2 + 45);
